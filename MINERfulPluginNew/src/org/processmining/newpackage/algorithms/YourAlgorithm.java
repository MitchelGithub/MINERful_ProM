...
public class YourAlgorithm {
	 ...
	 * @return The output.
	 */
	public YourOutput apply(PluginContext context, YourFirstInput input1, YourSecondInput input2, MinerParameters parameters) {
		/**
	    ...
	    YourOutput output = /*parameters.isYourBoolean() ? */true ? new YourOutput(input1) : new YourOutput(input2);

...
public class MinerFulMinerStarter extends AbstractMinerFulStarter {
	...
	public static InputCmdParameters inputParams2;
	public static MinerFulCmdParameters minerFulParams2;
	public static ViewCmdParameters viewParams2;
	public static SystemCmdParameters systemParams2;
     ...
     *  [alphabet]...
     */
    public static void main(String[] args, XLog log) {
        ...
        minerFulParams2 = minerFulParams;
        viewParams2 = viewParams;
	...
	private static LogParser deriveLogParserFromLogFile(InputCmdParameters inputParams, MinerFulCmdParameters minerFulParams) {
		...
		XLog inputFile = inputParams.inputFile;
		try {
			logParser = new XesLogParser( inputFile , ClassificationType.NAME);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
